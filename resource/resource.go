...
func configSeelogXml() (*asset, error) {
	...
	info := bindataFileInfo{name: "config/seelog.xml", size: 1096, mode: os.FileMode(438), modTime: time.Unix(1535293236, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
